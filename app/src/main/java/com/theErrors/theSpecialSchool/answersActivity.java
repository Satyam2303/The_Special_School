...
//        Toast.makeText(this, Integer.toString(a), Toast.LENGTH_SHORT).show();
        ...
        score.setText("Your Score is : "+Integer.toString(a)+"/"+Integer.toString(MainActivityQuiz.question.length));

        correctAdapter adapter=new correctAdapter(MainActivityQuiz.question, MainActivityQuiz.options, MainActivityQuiz.correctAnswer,this);
